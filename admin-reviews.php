...
.review-photo{display:block;width:min(260px,100%);max-height:220px;object-fit:contain;background:#f7faf8;border-radius:10px;margin:10px 0}
...
<p><strong>Product package photo:</strong> <?php if ($submission['product_photo']): ?><a target="_blank" rel="noopener" href="label-photo.php?submission_id=<?= (int) $submission['id'] ?>&amp;type=product_photo"><img class="review-photo" src="label-photo.php?submission_id=<?= (int) $submission['id'] ?>&amp;type=product_photo" alt="Submitted package photo for <?= showText($submission['name']) ?>"></a><?php else: ?>No photo supplied<?php endif; ?></p>

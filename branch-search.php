...
<?php if (!$lists): ?><p>Create a shopping list first. <a href="lists.php">My lists</a><a href="branch-search.php" aria-current="page">Find a branch</a></p><?php else: ?>
